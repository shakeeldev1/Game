    ...
    <div className="p-2">
      <div className="grid grid-cols-3 gap-3">
        {games.map((game, index) => (
          <div
            key={index}
            className="relative rounded-xl overflow-hidden text-center shadow-[0_4px_15px_rgba(0,0,0,0.5)] border border-purple-500/20 group cursor-pointer hover:border-cyan-400/50 transition-all duration-300"
          >
            {/* Background Image */}
            <img
              src={game.bgimage}
            ...
            {/* Overlay Content */}
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-t from-[#0f0720]/90 via-[#0f0720]/40 to-transparent">
              <img
                src={game.gameicon}
                alt={game.name}
